...
export const BenefitCard = () => {
  return (
    <div className='bg-app-white-90 w-full h-[340px] md:h-52 lg:h-64 xl:h-96 rounded-2xl p-10 md:p-8 grid grid-cols-1 space-y-2 md:space-y-8 lg:space-y-4 duration-500 hover:duration-500 hover:transition-all hover:bg-app-orange-50'>
      <h3
      ...
      <div className='w-full flex justify-end max-h-max'>
        <BoltIcon className='size-9 md:size-14 lg:size-16 text-app-grey-20' />
      </div>
    </div>
  );
};

export const BenefitCardLegacy = () => {
  return (
