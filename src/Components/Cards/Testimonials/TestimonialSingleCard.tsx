...
export const TestimonialSingleCard = () => {
  return (
    <div className='rounded-lg border-2 border-app-white-90 w-full h-[200px] md:h-[230px] lg:h-[280px] xl:h-[360px] p-4 md:p-6 lg:p-8 xl:p-12 flex flex-col justify-around'>
      <AppGeneralText />
